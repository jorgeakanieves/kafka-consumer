...
public class KafkaConsumerSjsStreaming implements SparkStreamingJob, Serializable {

    final static Logger logger = Logger.getLogger(KafkaConsumerSjsStreaming.class);
    private static final String JOB = "KafkaConsumerSjsStreaming";
    ...
    private static final String KAFKA_TARGET_GROUPID = "KafkaConsumerSjsStreaming";
    ...
    public Object runJob(Object sc, Config jobConfig) {
        ...
        props.put("zookeeper.consumer.connection", ZOOKEEPER_HOST+":"+KAFKA_PRODUCER_PORT);
        ...
        JavaStreamingContext streamingContext = new JavaStreamingContext((JavaSparkContext) sc, new Duration(Long.parseLong("2000")));
